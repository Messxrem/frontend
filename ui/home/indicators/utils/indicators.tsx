...
const dailyTxsIndicator: TChainIndicator<'stats_charts_txs'> = {
  ...
  icon: <IconSvg name="transactions" boxSize={ 6 } bgColor="#00E8AF" borderRadius="base" color="white"/>,
...
const marketPriceIndicator: TChainIndicator<'stats_charts_market'> = {
  ...
  icon: <IconSvg name="globe" boxSize={ 6 } bgColor="#00E8AF" borderRadius="base" color="white"/>,
...
const tvlIndicator: TChainIndicator<'stats_charts_market'> = {
  ...
  icon: <IconSvg name="lock" boxSize={ 6 } bgColor="#00E8AF" borderRadius="base" color="white"/>,
  // eslint-disable-next-line max-len
